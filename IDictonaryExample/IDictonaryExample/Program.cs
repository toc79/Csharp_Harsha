...
namespace namespace1
{
    ...
    public class CustomersList : IDictionary<int, Customer>
    {
    ...
    class Program
    {
        static void Main()
        {
            ...
            {
                Console.WriteLine(matchingCustomer.CustomerID + ", " + matchingCustomer.CustomerName + ", " + matchingCustomer.Email + ", " + matchingCustomer.CustomerType);
            }
            ...
            Console.WriteLine("Insert: " + customersList[2].CustomerID + ", " + customersList[2].CustomerName);

            //GetEnumerator
            //Console.WriteLine("GetEnumerator: " +customersList.GetEnumerator().ToString());
