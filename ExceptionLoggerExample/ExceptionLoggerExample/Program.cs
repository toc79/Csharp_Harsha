...
namespace ExceptionLoggerExample
{
	...
	public class ExceptionLogger
	{
		public static void AddException(Exception ex)
		{
			...
			StreamWriter streamWriter = File.AppendText(filePath); //you can't use new StreamWriter(filePath) because file would be overwritten on every call of method AddException
	...
	class Program
	{
		static void Main()
		{
			...
			catch (InsufficientFundsException ex) //it catches the object of InvalidOperationException which was thrown in 'Transfer' method
			{
				Console.WriteLine(ex.Message);
